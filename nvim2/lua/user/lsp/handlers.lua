...
local function lsp_keymaps(bufnr)
	...
	keymap(bufnr, "n", "<leader>ig", "<cmd>lua vim.lsp.buf.definition()<CR>", opts)
	...
	keymap(bufnr, "n", "<leader>lw", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
	keymap(bufnr, "n", "<leader>lsi", "<cmd>LspInfo<cr>", opts)
	keymap(bufnr, "n", "<leader>lsm", "<cmd>Mason<cr>", opts)
	keymap(bufnr, "n", "<leader>en", "<cmd>lua vim.diagnostic.goto_next({buffer=0})<cr>", opts)
